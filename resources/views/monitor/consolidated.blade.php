...
@section('content')
    <form action="{{ asset('monitoring/consolidated') }}" method="POST">
        {{ csrf_field() }}
        <div class="row" style="margin-top: -0.5%;margin-bottom: 1%">
            ...
            <button type="submit" class="btn btn-success btn-flat"><i class="fa fa-check"></i> Filter</button>
        </div>
    </form>
    <?php
        $user = Session::get('auth');
                                    ...
                                    <p >
                                        <?php
                                            if($user->facility_id == $row->id){
                                                $viewed_only_href = asset('monitor/no_action').'/'.$facility_id.'/'.$date_start.'/'.$date_end.'/referred_to';
                            ...
                            <div class="col-md-4 ">
                                <div class="box-body box-profile">
                                    ...
                                    <p>
                                        <?php
                                            if($user->facility_id == $row->id){
                                                $viewed_only_href = asset('monitor/no_action').'/'.$facility_id.'/'.$date_start.'/'.$date_end.'/referred_from';
                                                $viewed_only_target = "_target";
                                            } else {
                                                $viewed_only_href = '#';
                                                $viewed_only_target = "";
