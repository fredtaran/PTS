<?php
    ...
    $inventory = \App\Models\Inventory::where("facility_id", @$myfacility->id)->get();
                ...
                <div class="form-group-sm form-inline">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="clinical_status" id="clinical_status" class="form-control-select" style="width: 100%;">
                                <option value="">Select option</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="sur_category" id="sur_category" class="form-control-select" style="width: 100%;">
                                <option value="">Select option</option>
                    ...
                    <table class="table table-striped">
                        ...
                        <td colspan="6">
                                ...
                                <button class="btn btn-info btn-flat btn_add_diag"><i class="fa fa-plus"></i> Add Row</button>
                                <button class="btn btn-danger btn-flat btn_delete_diag"><i class="fa fa-plus"></i> Delete</button>
                                <!-- <span><input type="button" class="" value="Add Row"><i class="fa fa-times"></i></span> -->
                                    @if(Auth::user()->level == 'opcen')
                                        Chief Complaints
                                    @else
...
<div class="modal fade" role="dialog" id="vital_modal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
