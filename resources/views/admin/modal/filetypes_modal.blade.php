<div class="modal fade" role="dialog" id="filetypes_modal">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-body filetypes_body">
                <center>
...
<div class="modal fade" role="dialog" id="filetype_delete">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form action="{{ asset('admin/filetype/delete') }}" method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" name="filetype_id" class="filetype_id">
                    <div class="alert alert-danger">
                        <label for="" class="text-danger">Are you sure you want to delete this filetype?</label>
                    </div>
